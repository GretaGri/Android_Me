...
public class BodyPartFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (imageIds != null){
            ...
            //show log message saying the the image id list is null
    ...
    //Setter methods of keeping track of the list images this fragment can display ans which image
    //on the list is currently being displayed
